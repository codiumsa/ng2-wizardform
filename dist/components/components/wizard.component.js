...
var WizardComponent = (function () {
    ...
    WizardComponent.prototype.getStepAtIndex = function (stepIndex) {
        ...
        return this.wizardSteps.find(function (item, index, array) { return index === stepIndex; });
    };
    /**
    ...
    WizardComponent.prototype.getIndexOfStep = function (step) {
        var stepIndex = -1;
        this.wizardSteps.forEach(function (item, index, array) {
            if (item === step) {
                stepIndex = index;
            }
        });
    ...
    WizardComponent.prototype.canGoToStep = function (stepIndex) {
        ...
        this.wizardSteps.forEach(function (wizardStep, index, array) {
